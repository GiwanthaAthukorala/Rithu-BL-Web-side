              ...
              <div className="p-8 lg:p-10 border-b border-gray-100">
                ...
                <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-8 rounded-3xl border-2 border-blue-200 shadow-lg">
                  ...
                  {/* <div className="space-y-4">
                    <a
                      href="https://www.instagram.com/reel/DQ3RgmREzs2/?igsh=N3U2ZnFud2Zha3M4"
                      target="_blank"
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <p className="text-white/90 text-sm">
                          ඉන්ස්ට්‍රග්‍රෑම් එකවුන්ට් එක ෆලෝ කරන්න •Japan Cosmetic
                          Mart LK
                        </p>
                      </div>
                      <a
                        href="https://www.instagram.com/japan_cosmetic_mart_lk?igsh=MW5ybnllcmMyYWQ5Ng=="
                        target="_blank"
                        rel="noopener noreferrer"

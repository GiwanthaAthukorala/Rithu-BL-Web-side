          ...
          <div className="mb-8 bg-blue-50 p-4 rounded-lg">
            ...
            {/*  <li>
              ...
              <a
                ...
                className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium"
              >
                Weda Madura - ඉන්ස්ට්‍ර ග්‍රෑම් එකව්න්ට් එක ෆලෝ කරන්න ෆලෝ කරන්න{" "}
            ...
            <li>
              {" "}
              <a
                href="https://www.instagram.com/zaccai.lk?igsh=YndkdmI4N2l6ZGdt&utm_source=qr"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium"
              >
                ZACCAI - ඉන්ස්ට්‍ර ග්‍රෑම් එකව්න්ට් එක ෆලෝ කරන්න ෆලෝ කරන්න{" "}
                <ExternalLink className="w-4 h-4 ml-1" />
              </a>
            </li>
            <li>
              {" "}
              <a
                href="https://www.instagram.com/kaveesha_ru?igsh=MW15OXQwenNla2YweA%3D%3D&utm_source=qr"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium"
              >
                Kaveesha Rukshan - ඉන්ස්ට්‍රග්‍රැම් එකව්න්ට් එක ෆලෝ කරන්න (Visit
                our Instagram Profile) <ExternalLink className="w-4 h-4 ml-1" />
              </a>
            </li>{" "}
            <li>
              {" "}

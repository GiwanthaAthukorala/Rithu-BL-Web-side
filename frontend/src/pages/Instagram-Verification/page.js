...
export default function InstagramVerificationTask() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg mx-auto p-6 flex items-center min-h-screen">
          <div className="bg-white/95 backdrop-blur-xl p-12 rounded-3xl shadow-2xl text-center w-full border border-white/20 transform animate-scale-in">
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-2xl mb-8 border-2 border-green-200">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 text-white px-8 py-4 rounded-2xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 font-bold text-lg"
            >
              View Your Earnings
            </button>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 relative overflow-hidden">
      {/* Animated background */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute w-96 h-96 bg-white/5 rounded-full blur-3xl top-20 left-10 animate-float"></div>
        <div className="absolute w-80 h-80 bg-white/5 rounded-full blur-3xl bottom-20 right-10 animate-float-delayed"></div>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto p-4 py-8">
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/20">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <p className="text-white/90 text-sm">
                      ඉන්ස්ට්‍රග්‍රෑම් එකවුන්ට් එක ෆලෝ කරන්න • Camui Sri Lanka
                    </p>
                  </div>
                  <a
                    href="https://www.instagram.com/camui.lk/"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Requirements */}
          <div className="p-8 lg:p-10 bg-gradient-to-br from-amber-50 to-yellow-50 border-b border-amber-100">
              ...
              <div className="mb-8">
                {preview ? (
                  ...
                  >
                    ...
                    <label className="inline-block bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 text-white px-10 py-4 rounded-2xl cursor-pointer hover:shadow-2xl transform hover:scale-105 transition-all duration-300 font-bold text-lg">
                      Choose File
                      <input
                        type="file"
                        accept=".png,.jpg,.jpeg"

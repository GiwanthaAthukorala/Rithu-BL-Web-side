              ...
              <div className="p-8 lg:p-10 border-b border-gray-100">
                ...
                <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-8 rounded-3xl border-2 border-blue-200 shadow-lg">
                  ...
                  <div className="space-y-4">
                    <a
                      href="https://www.instagram.com/p/DQha_daE5aD/?igsh=MTRjdWJrcDU3NDRteQ=="
                      target="_blank"
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <p className="text-white/90 text-sm">
                          ඉන්ස්ට්‍රග්‍රෑම් එකවුන්ට් එක ෆලෝ කරන්න • 6 posts 123
                          followers 1 following Royal Linen Shopping & retail
                          Luxury in every thread.
                        </p>
                      </div>
                      <a
                        href="https://www.instagram.com/royal_.linen?igsh=ZHV1bWFiN2hzZHht"
                        target="_blank"
                        rel="noopener noreferrer"
